  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex gap-4 border-b border-gray-200">
        ...
        <Link href="/auth/signup" className="pb-4 text-gray-500 hover:text-gray-700 transition-colors">
          Create Account
        </Link>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <Link href="/auth/forgot-password" className="text-sm text-amber-900 hover:underline">
            Forgot password?
          </Link>
        </div>
        <div className="relative">
      ...
      <div className="flex items-center">
        <input
          ...
          className="w-4 h-4 border-gray-300 rounded text-amber-900 focus:ring-amber-500"
        />
