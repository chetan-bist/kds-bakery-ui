...
export const metadata: Metadata = {
  title: "Sign In - KDS Bakery",
  description: "Sign in to your KDS Bakery account to track orders and earn rewards.",
}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white ">
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-gray-600">Sign in to track your custom cake orders and earn rewards.</p>
          </div>
          ...
          <div className="space-y-4">
            <div className="text-center">
              ...
              <Link href="/auth/signup" className="font-semibold text-amber-900 hover:underline">
                Join the Family
              </Link>
            </div>
